<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="UpdateRide.aspx.cs" Inherits="Project.UpdateRide" %>
    ...
    <div id="attractionsdetails" style=" margin: 0 auto; height:800px; background-image:url(Images/blue.jpg); background-repeat:no-repeat; background-attachment:fixed; background-size:100% 100%; font-size:larger;">
            <div id="internal" style="width:800px; margin: 0 auto;">
                ...
                <br /><br />
                    ...
                    <h2 style="text-align:center">UPDATE RIDE DETAILS</h2>
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><asp:TextBox ID="TextPrice" TextMode="Number" runat="server" 
                                    Height="30px" Width="180px"></asp:TextBox></td>
                            <td></td>
                            <td><asp:Button ID="Button1" class="button" runat="server" placeholder="Enter PRICE" Text="UPDATE" 
                        ...
                        <tr>
                            ...
                            <td><asp:TextBox ID="TextPersons" TextMode="Number" runat="server" 
                                    Height="30px" Width="180px"></asp:TextBox></td>
                            <td></td>
                            <td><asp:Button ID="Button4" class="button" Height="40px" runat="server" placeholder="Enter NUMBER" Text="UPDATE" onclick="BtnPersons_Click" /></td>  
                        </tr>
                        ...
                        <tr>
                            <td><b>AGE LIMIT:</b></td>
                            <td><asp:TextBox ID="TextAgeLimit" TextMode="Number" placeholder="Enter AGE-LIMIT" runat="server" 
                                    Height="30px" Width="180px"></asp:TextBox></td>
                            <td></td>
                            <td><asp:Button ID="Button5" class="button" Height="40px" runat="server" Text="UPDATE" onclick="BtnAge_Click" /></td>  
                        </tr>
                        <tr><td><asp:Label ID="LabelAge" runat="server" ForeColor="Red" Text="Sucessfully Updated Age Limit..!!" Visible="false"></asp:Label></td></tr> 
                        <tr><td><asp:Label ID="LabelAgeInvalid" runat="server" ForeColor="Red" Text="ERROR...Cannot Update...!!" Visible="false"></asp:Label></td></tr> 
                    </table>
